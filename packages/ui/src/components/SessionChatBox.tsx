...
export function SessionChatBox<TExecutor extends string = string>({
  ...
  const placeholder = isInFeedbackMode
    ? t("conversation.placeholders.feedback")
    : isInEditMode
      ? t("conversation.placeholders.edit")
      : isInApprovalMode
        ? t("conversation.placeholders.approval")
        : isInAskQuestionMode
          ? t("conversation.placeholders.differentAnswer")
          : session.isNewSessionMode
            ? t("conversation.placeholders.newConversation")
            : t("conversation.placeholders.continueTask");
                ...
                <>
                  ...
                  {onOpenWorkspace ? (
                    <PrimaryButton
                      ...
                      value={t("conversation.actions.openWorkspace")}
      ...
      footerLeft={
        <>
          ...
          {onPrCommentClick && (
            <ToolbarIconButton
              icon={GithubLogoIcon}
              aria-label={t("conversation.actions.addPrComments")}
              title={t("conversation.actions.insertPrComments")}
