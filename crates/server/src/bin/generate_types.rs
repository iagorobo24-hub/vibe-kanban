...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::execution_telemetry::ExecutionTelemetry::decl(),
        db::models::execution_telemetry::RecordExecutionTelemetry::decl(),
        db::models::execution_telemetry::TelemetrySummaryRow::decl(),
        server::routes::telemetry::TelemetryListParams::decl(),
        engram::ContextGrant::decl(),
        engram::MemoryEntry::decl(),
        server::routes::engram::CreateGrantPayload::decl(),
        server::routes::engram::ListGrantsParams::decl(),
        server::routes::engram::ListEntriesParams::decl(),
        executors::catalog::ModelProviderKind::decl(),
        executors::catalog::CostClass::decl(),
        executors::catalog::SpeedClass::decl(),
        executors::catalog::CapabilityTag::decl(),
        executors::catalog::ModelRoute::decl(),
        executors::catalog::ProviderAccount::decl(),
        executors::catalog::WorkModeRole::decl(),
        executors::catalog::WorkMode::decl(),
        executors::catalog::RoutingRequest::decl(),
        executors::catalog::RoutingRecommendation::decl(),
        executors::catalog::ModelProviderCatalog::decl(),
        services::services::swarm::SwarmSubTaskStatus::decl(),
        services::services::swarm::SwarmPlanStatus::decl(),
        services::services::swarm::SwarmGoal::decl(),
        services::services::swarm::SwarmSubTask::decl(),
        services::services::swarm::SwarmPlan::decl(),
        services::services::swarm::ConsolidationReport::decl(),
        server::routes::engram::CreateEntryPayload::decl(),
        server::routes::engram::RevokeGrantPayload::decl(),
        ...
        executors::executors::freebuff::Freebuff::decl(),
        ...
        services::services::design_system::UIStyleInfo::decl(),
        services::services::design_system::ColorPaletteInfo::decl(),
        services::services::design_system::TypographyInfo::decl(),
        services::services::design_system::ChecklistItem::decl(),
        services::services::design_system::DesignSystemTokens::decl(),
        services::services::design_system::GenerateDesignSystemRequest::decl(),
        services::services::design_system::DesignViolation::decl(),
        services::services::design_system::AuditDesignSystemResult::decl(),
        server::routes::workspaces::design::SaveDesignSystemBody::decl(),
...
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    ...
    let schemas: HashMap<&str, String> = HashMap::from([
        ...
        (
            "freebuff",
            generate_json_schema::<executors::executors::freebuff::Freebuff>()?,
        ),
    ]);
    println!(
